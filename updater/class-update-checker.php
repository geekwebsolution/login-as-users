<?php
if (!class_exists('GWSLAU_Update_Checker')) {

    class GWSLAU_Update_Checker {
        ...
        public function __construct() {
            $utility = gwslau_updater_utility();
        ...
        public function check_for_updates($transient) {
            ...
            $transient_name = 'gwslau_plugin_updates';
